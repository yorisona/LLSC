SET NAMES UTF8;
DROP DATABASE IF EXISTS llsc;
CREATE DATABASE llsc CHARSET=UTF8;
USE llsc;


/**笔记本电脑型号家族**/
CREATE TABLE llsc_laptop_family(
  fid INT PRIMARY KEY AUTO_INCREMENT,
  fname VARCHAR(32)
);

/**笔记本电脑**/
CREATE TABLE llsc_laptop(
...
/**收货地址信息**/
CREATE TABLE llsc_receiver_address(
...
/**购物车条目**/
CREATE TABLE llsc_shoppingcart_item(
...
/**用户订单**/
CREATE TABLE llsc_order_detail(
...
/****首页轮播广告商品****/
CREATE TABLE llsc_index_carousel(
...
/****首页商品****/
CREATE TABLE llsc_index_product(
  pid INT PRIMARY KEY AUTO_INCREMENT,
  title VARCHAR(64),
  details VARCHAR(128),
  pic VARCHAR(128),
...
/*******************/
/**笔记本电脑型号家族**/
INSERT INTO llsc_laptop_family VALUES
...
/**笔记本电脑**/
INSERT INTO llsc_laptop VALUES
...
/**笔记本电脑图片**/
INSERT INTO llsc_laptop_pic VALUES
...
/****首页轮播广告商品****/
INSERT INTO llsc_index_carousel VALUES
...
/****首页商品****/
INSERT INTO llsc_index_product VALUES
...
INSERT INTO llsc_news VALUES(null,'123','http://127.0.0.1:3000/1.png',now(),0,'123');
INSERT INTO llsc_news VALUES(null,'124','http://127.0.0.1:3000/1.png',now(),0,'123');
INSERT INTO llsc_news VALUES(null,'125','http://127.0.0.1:3000/1.png',now(),0,'123');
INSERT INTO llsc_news VALUES(null,'126','http://127.0.0.1:3000/1.png',now(),0,'123');
INSERT INTO llsc_news VALUES(null,'127','http://127.0.0.1:3000/1.png',now(),0,'123');
INSERT INTO llsc_news VALUES(null,'128','http://127.0.0.1:3000/1.png',now(),0,'123');
INSERT INTO llsc_news VALUES(null,'129','http://127.0.0.1:3000/1.png',now(),0,'123');
INSERT INTO llsc_news VALUES(null,'123a','http://127.0.0.1:3000/1.png',now(),0,'123');
INSERT INTO llsc_news VALUES(null,'123b','http://127.0.0.1:3000/1.png',now(),0,'123');
INSERT INTO llsc_news VALUES(null,'123c','http://127.0.0.1:3000/1.png',now(),0,'123');
INSERT INTO llsc_news VALUES(null,'123d','http://127.0.0.1:3000/1.png',now(),0,'123');
INSERT INTO llsc_news VALUES(null,'123e','http://127.0.0.1:3000/1.png',now(),0,'123');
INSERT INTO llsc_news VALUES(null,'123f','http://127.0.0.1:3000/1.png',now(),0,'123');
INSERT INTO llsc_news VALUES(null,'123g','http://127.0.0.1:3000/1.png',now(),0,'123');
INSERT INTO llsc_news VALUES(null,'123h','http://127.0.0.1:3000/1.png',now(),0,'123');
INSERT INTO llsc_news VALUES(null,'123i','http://127.0.0.1:3000/1.png',now(),0,'123');
INSERT INTO llsc_news VALUES(null,'123j','http://127.0.0.1:3000/1.png',now(),0,'123');
INSERT INTO llsc_news VALUES(null,'123k','http://127.0.0.1:3000/1.png',now(),0,'123');
INSERT INTO llsc_news VALUES(null,'123l','http://127.0.0.1:3000/1.png',now(),0,'123');
INSERT INTO llsc_news VALUES(null,'123m','http://127.0.0.1:3000/1.png',now(),0,'123');


#功能二:创建评论表
#内容;时间;那条新闻;编号
#DROP TABLE llsc_comment;
CREATE TABLE llsc_comment(
  id INT PRIMARY KEY AUTO_INCREMENT,
  content VARCHAR(50),
  ctime DATETIME,
  nid   INT
);
INSERT INTO llsc_comment VALUES(null,'赞一个1',now(),5);
INSERT INTO llsc_comment VALUES(null,'赞一个2',now(),5);
INSERT INTO llsc_comment VALUES(null,'赞一个3',now(),5);
INSERT INTO llsc_comment VALUES(null,'赞一个4',now(),5);
INSERT INTO llsc_comment VALUES(null,'赞一个5',now(),5);
INSERT INTO llsc_comment VALUES(null,'赞一个6',now(),5);
INSERT INTO llsc_comment VALUES(null,'赞一个7',now(),5);
INSERT INTO llsc_comment VALUES(null,'赞一个8',now(),5);
INSERT INTO llsc_comment VALUES(null,'赞一个9',now(),5);
INSERT INTO llsc_comment VALUES(null,'赞一个10',now(),5);
INSERT INTO llsc_comment VALUES(null,'赞一个11',now(),5);

#创建用户登录表
#用户登录密码需要加密保存使用  mysql自带函数md5()
CREATE TABLE llsc_login(
  id INT PRIMARY KEY AUTO_INCREMENT,
  uname VARCHAR(25),
  upwd  VARCHAR(32)
);
INSERT INTO llsc_login VALUES(null,'tom',md5('123'));


#创建购物车表 id count price pid uid
CREATE TABLE llsc_cart(
  id    INT PRIMARY KEY AUTO_INCREMENT,
  count INT,
  price DECIMAL(15,2),
  pid   INT,
